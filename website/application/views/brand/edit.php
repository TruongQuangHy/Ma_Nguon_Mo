        ...
        ?>
            ...
            <form action="<?php echo base_url('brand/update/'.$brand->id) ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo $brand->title ?>" type="text" name="title" class="form-control" id="slug" onkeyup="ChangeToSlug();">
                    <?php echo '<span class="text text-danger">' .form_error('title').'</span>' ?>  
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Slug</label>
                    <input value="<?php echo $brand->slug ?>" type="text" name="slug" class="form-control" id="convert_slug">
                ...
                <div class="mb-3">
                    ...
                    <img src="<?php echo base_url('uploads/brand/'.$brand->image) ?>" width="100px" height="100px" alt="">
